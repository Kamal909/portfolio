			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="space-y-8 sm:space-y-12">
					{[
						...
						{
							title: 'Trux411 E-commerce PWA',
							description: 'Trux411 is a Laravel-based E-commerce platform designed as a Progressive Web App (PWA), offering users a seamless shopping experience across devices. It supports offline access, fast loading times, and optimized performance—perfect for users in areas with limited connectivity.',
							metrics: {
								performance: 95,
								accessibility: 98,
								seo: 100,
							},
							techDetails: ['Service Worker implementation', 'CRDT implementation', 'Custom state management', 'WebRTC integration'],
							image: '/Trux411.png',
						},
					].map((project) => (
